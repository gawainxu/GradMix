...
def parse_option():
    ...
    parser.add_argument("--exemplar_features_path", type=str,
                        default="/features/FUB_simCNN_mixup_positive_alpha_1.0_beta_1.0_layersaliencymix_0,1,2,3_SimCLR_1.0_1.0_0.05_trail_0_128_128_old_augmented_600_train")
    parser.add_argument("--testing_known_features_path", type=str,
                        default="/features/FUB_simCNN_mixup_positive_alpha_1.0_beta_1.0_layersaliencymix_0,1,2,3_SimCLR_1.0_1.0_0.05_trail_0_128_128_old_augmented_600_test_known")
    parser.add_argument("--testing_unknown_features_path", type=str,
                        default="/features/FUB_simCNN_mixup_positive_alpha_1.0_beta_1.0_layersaliencymix_0,1,2,3_SimCLR_1.0_1.0_0.05_trail_0_128_128_old_augmented_600_test_unknown")
