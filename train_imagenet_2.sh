...
#python3 main_supcon_old.py --epochs 600 --save_freq 50 --batch_size 256 --learning_rate 0.001 --cosine True --lr_decay_rate 0.8 --model "resnet18" --datasets "tinyimgnet" --size 256 --trail 5 --temp 0.1 --method "SimCLR" --method_gama 1.0 --method_lam 0.0 --randaug 0 --mixup_positive False --record_grad False
