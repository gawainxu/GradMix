...
python3 featureVisulize.py --inlier_features_path "/features/tinyimgnet_resnet18_original_data__mixup_positive_alpha_1.0_beta_1.0_layersaliencymix_no_SimCLR_1.0_1.0_0.05_trail_2_128_256_400_train" --num_classes 20 --save_path "/plots/cifar10_resnet18_temp_0.05_id_5_lr_0.01_bz_256_train_tsne.pdf" --reduced_len 0
